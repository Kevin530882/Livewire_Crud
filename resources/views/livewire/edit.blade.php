            ...
            <div class="card-body">
                <form wire:submit="save" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                            <input type="number" step="0.01" class="form-control @error('price') is-invalid @enderror" id="price" wire:model="price" value="{{ $product->price }}">
                            @error('price')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <!-- <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                            <input type="file" wire:model="fileUpload" id="" class="form-control @error('image') is-invalid @enderror">
                            @error('image')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
